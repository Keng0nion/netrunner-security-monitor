...
![NETRUNNER sample output (privacy fields redacted)](./docs/screenshot.png)
...
- [Data Architecture](#data-architecture)
  - [Three Data Layers](#three-data-layers)
- [Identity and Historical Baseline](#identity-and-historical-baseline)
- [Threat Analysis Basis](#threat-analysis-basis)
- [Quick Start](#quick-start)
- [Unified CLI](#unified-cli)
- [Collection Tier Trade-offs](#collection-tier-trade-offs)
- [Java / C / C++ External Analysis Backends](#java--c--c-external-analysis-backends)
- [Node.js Standalone Collector and JSONL](#nodejs-standalone-collector-and-jsonl)
- [Build and `dist/` Limitations](#build-and-dist-limitations)
- [Legacy Entry Compatibility](#legacy-entry-compatibility)
- [Directory Structure](#directory-structure)
- [Tests and Static Checks](#tests-and-static-checks)
